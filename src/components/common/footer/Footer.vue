        ...
        <div class="space-y-7">
          ...
          <div class="flex gap-2.5">
            <a
              ...
              target="blank"
              class="size-10 rounded-sm hover:bg-secondary bg-white/5 flex items-center justify-center group transition-all ease-in-out duration-500"
            >
              <svg
                width="8"
                height="14"
                ...
                class="text-white group-hover:text-primary transition-all ease-in-out duration-500"
              >
                <path
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M7.50609 3.64844C5.37739 3.64844 3.65039 5.37436 3.65039 7.50173C3.65039 9.6291 5.37739 11.355 7.50609 11.355C9.63479 11.355 11.3618 9.6291 11.3618 7.50173C11.3618 5.37436 9.63479 3.64844 7.50609 3.64844ZM7.50609 10.0012C6.12508 10.0012 5.00502 8.88188 5.00502 7.50173C5.00502 6.12158 6.12508 5.00222 7.50609 5.00222C8.88711 5.00222 10.0072 6.12158 10.0072 7.50173C10.0072 8.88188 8.88711 10.0012 7.50609 10.0012Z"
                  fill="currentColor"
                />
                <path
                  d="M12.4136 3.49529C12.4136 3.99344 12.009 4.39489 11.5134 4.39489C11.015 4.39489 10.6133 3.99051 10.6133 3.49529C10.6133 2.99715 11.0179 2.5957 11.5134 2.5957C12.009 2.5957 12.4136 3.00008 12.4136 3.49529Z"
                  fill="currentColor"
                />
              </svg>
            </a>
