      ...
      <div class="flex pb-20 justify-between">
        ...
        <div class="pr-20">
          ...
          <ul class="space-y-4 text-lg font-medium text-text">
            <li class="flex gap-4"><PhoneCall /> (+880) 000 88 99</li>
            <li class="flex gap-4"><MessageCircleMore /> contact@info.com</li>
      ...
      >
        ...
        <div className="flex  gap-3 items-center ml-4 xl:pr-0 pr-5">
          <a
            ...
            class="shadow-[0px_1px_2px_0px_#01103D24] size-[38px] bg-white rounded-[10px] flex items-center justify-center group hover:bg-purple transition-all ease-in-out duration-500"
          >
            <svg
              width="8"
              height="14"
