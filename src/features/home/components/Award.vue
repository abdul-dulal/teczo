        ...
        <div>
          <div class="award-list grid grid-cols-2 space-y-5">
            <div class="award-item flex flex-wrap md:gap-[25px] gap-4">
              ...
              <div>
                <h4 class="heading-four max-w-[250px] leading-[30px] mb-2">
                  Festival of design week, Berlin
                </h4>
            ...
            <div class="award-item flex flex-wrap md:gap-[25px] gap-4">
              ...
              <div>
                <h4 class="heading-four max-w-[250px] leading-[30px] mb-2">
                  9th International faith express
                </h4>
                <li class="paragraph list-inside">January, 2025</li>
              </div>
            </div>
        ...
        <div v-for="(item, index) in experts" :key="index" class="expert-card">
          <div>
            <div class="relative rounded-2xl overflow-hidden group">
              ...
              <div
                class="absolute bottom-0 left-0 w-[60px] h-0 group-hover:h-[136px] bg-secondary rounded-tr-[20px] rounded-bl-[20px] overflow-hidden transition-all duration-300 flex flex-col gap-5 items-center group-hover:py-5"
              >
                <a href="https://www.instagram.com/?hl=en" target="blank">
                  <svg
                    ...
                    class="text-primary hover:text-purple cursor-pointer"
                  >
                    <path
                ...
                <a href="https://vimeo.com/log_in" target="blank">
                  <svg
                    width="13"
                    height="12"
                    viewBox="0 0 13 12"
            ...
            <h4 class="heading-four mt-[30px]">{{ item.name }}</h4>
            <p class="paragraph text-[#838694]">{{ item.design }}</p>
          </div>
        </div>
      </div>
    </div>
